    ...
    <div id="side" style="left: 0">
        ...
        <div id="side_nav">
            ...
            <div id="nav_list">
                ...
                <a id="now_page" href="information.php" style="text-decoration: underline; text-decoration-color: #F7E0A1">
					<img src="images/circle.png" style="text-align" width="40" height="40"/>Information</a>
